...
- Package: `com.godaddy.asherah:asherah-java`
...
- `com.godaddy.asherah:asherah-java` (new API, existing)
- `com.godaddy.asherah:asherah-java-compat` (canonical API surface, depends on asherah-java)
